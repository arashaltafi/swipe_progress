...
import com.arash.altafi.swipebutton.databinding.LayoutSwipeButtonBinding
import com.arash.altafi.swipebutton.logE

class Swipe : RelativeLayout {
                    ...
                    MotionEvent.ACTION_MOVE -> {
                        ...
                        if (event.x > binding.llSwipe.width / 2 &&
                            ...
                            if (binding.flSliding.layoutDirection == LAYOUT_DIRECTION_RTL) {
                                "onTouch RTL: ${0 + 1.3f * (binding.llSwipe.x - binding.llSwipe.width) / width}".logE(
                                    "onTouch"
                                )
                                ...
                                "onTouch LTR: ${1 - 1.3f * (binding.llSwipe.x + binding.llSwipe.width) / width}".logE(
                                    "onTouch"
                                )
                                binding.llSwipe.x = event.x - binding.llSwipe.width / 2
                                binding.view.alpha =
    ...
    private fun moveButtonBack() {
        ...
        positionAnimator.addUpdateListener {
            ...
            binding.llSwipe.x = x
            "moveButtonBack x: $x".logE("moveButtonBack")
        }
        positionAnimator.addListener(object : AnimatorListenerAdapter() {
            override fun onAnimationEnd(animation: Animator) {
                super.onAnimationEnd(animation)
                "onAnimationEnd".logE("moveButtonBack")
            }

            override fun onAnimationStart(animation: Animator?) {
                super.onAnimationStart(animation)
                "onAnimationStart".logE("moveButtonBack")
            }
        })
    ...
    private fun expandButton() {
        ...
        positionAnimator.addUpdateListener {
            val x = positionAnimator.animatedValue as Float
            binding.llSwipe.x = x
            "expandButton x: $x".logE("expandButton")
        }
        ...
        animatorSet.addListener(object : AnimatorListenerAdapter() {
            override fun onAnimationStart(animation: Animator?) {
                super.onAnimationStart(animation)
                isActive = true
                "onAnimationStart".logE("animationSwipe")
            }
            ...
            override fun onAnimationEnd(animation: Animator) {
                ...
                "onAnimationEnd".logE("animationSwipe")
            }
        })
...
//        animatorSet.duration = 10
    ...
    private fun collapseButton() {
        ...
        animatorSet.start()
        "collapseButton".logE("collapseButton")
    }
